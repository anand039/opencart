...
Call log:
  - waiting for locator('#input-firstname')
    - waiting for" http://localhost/opencart/upload/index.php?route=account/register" navigation to finish...
    - navigated to "http://localhost/opencart/upload/index.php?route=account/register"
